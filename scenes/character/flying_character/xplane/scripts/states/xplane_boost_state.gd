...
@export_group("FOV Curves")
@export var _enter_fov_curve: Curve
@export var _exit_fov_curve: Curve
...
func enter(_last_state: State):
	...
	PlayerManager.character.camera_component.transition_fov(_enter_fov_curve)
	_active = true;
