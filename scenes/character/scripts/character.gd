...
func _rotate_character_toward_reticle(delta: float, yaw_speed: float =  3, pitch_speed: float =  2.0, exclude_pitch: bool = true) -> void:
...
func _handle_rail_movement() -> void:
...
func clamp_position_by_tolerance() -> void:
...
func set_move_in_frame_speed(val: float) -> void:
